                        ...
                        finally
                        {
                            ...
                            //loadData.ExecuteLoader(csvFile);
                                ...
                                try
                                {
                                    ...
                                    var uploadFile = new UploadFileToApi();
                                 string response = await   uploadFile.UploadFileToApiAsync(apiEndpoint, csvFile);
                                ...
                                {
                                    Log.Information("Exception occurred while calling the api: " + ex.Message);
                                }
                        }
                    }
